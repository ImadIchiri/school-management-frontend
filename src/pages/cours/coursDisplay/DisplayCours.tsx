    ...
    <div className="p-6 bg-[#DFF6F5] min-h-screen">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow border border-[#7ED4D1] p-6">
        ...
        <p className="text-gray-700 mb-4">
          ...
          Ce Cours contient les détails complets, cours associés,
        ...
        <div className="flex justify-end gap-3 mt-6">
          ...
          <button onClick={() => navigate(`/Cours/update/${id}`)} className="px-4 py-2 rounded bg-[#30B2AC] text-white hover:bg-[#279D99]">
            Update
          </button>
        </div>
      </div>
